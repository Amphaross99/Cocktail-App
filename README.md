...
- Cocktailname und Glas-Icon kollidieren nicht mehr.
- Rezeptkarten-Header wurde vereinfacht.
- Mehr Abstand zwischen Cocktailname und Rezeptkarte.
- Glas-Emoji bleibt erhalten.


## v20

- Glas-Icons wurden final auf Emojis zurückgestellt.
- Shooter nutzt 🔫.
- Zutaten können jetzt auch Einheiten wie `dashes` speichern.
- CSV unterstützt optional die Spalte `unit`.
- Werte wie `2 dashes` in `amount_ml` werden beim Import erkannt und korrekt angezeigt.
