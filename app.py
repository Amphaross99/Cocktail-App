...
def glass_icon_html(icon: str, label: str, size: int = 36) -> str:
    return (
        f'<div title="{label}" style="display:flex;align-items:center;justify-content:center;'
        f'width:{size + 10}px;height:{size + 10}px;'
        f'border:1px solid rgba(212,175,55,.22);border-radius:12px;'
        f'background:rgba(212,175,55,.06);font-size:{max(22, int(size * 0.72))}px;line-height:1;">'
        f'{icon}</div>'
    )
